...
# ==========================================================
# DATABASE MIGRATION FOR EXISTING RENDER DATABASE
# ==========================================================
# SQLAlchemy create_all() creates missing tables, but it does not
# add newly introduced columns to tables that already exist.
# Render PostgreSQL may therefore contain an older `classes` table
# without the `active` column. This migration adds it safely.
...
def ensure_database_schema():
    ...
    with engine.begin() as connection:
        ...
        if "classes" in table_names:
            ...
            columns = {
                column["name"]
                for column in inspector.get_columns("classes")
            }
